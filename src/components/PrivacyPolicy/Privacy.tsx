...
function Privacy() {
  return (
    <section className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg max-w-4xl mx-auto my-8">
      <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-4">Privacy Policy</h1>
      <p className="text-gray-700 dark:text-gray-300 mb-4">
        Your privacy is important to us. This privacy statement explains the personal data we collect from you and how we use it.
      </p>
      ...
      <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-2">2. How We Use Information</h2>
      <p className="text-gray-700 dark:text-gray-300 mb-4">
      ...
      <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-2">3. Information We Share</h2>
      <p className="text-gray-700 dark:text-gray-300 mb-4">
      ...
      <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-2">4. Information Security</h2>
      <p className="text-gray-700 dark:text-gray-300 mb-4">
      ...
      <h2 className="text-2xl font-semibold text-gray-800 dark:text-white mb-2">5. Changes</h2>
      <p className="text-gray-700 dark:text-gray-300 mb-4">
