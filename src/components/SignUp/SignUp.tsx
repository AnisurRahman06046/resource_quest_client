...
function SignUp() {
  ...
  return (
    <section className="gradient-form  w-screen h-[calc(100vh-150px)] overflow-y-scroll relative   bg-neutral-200 dark:bg-neutral-700 ">
      <div className=" w-full h-full">
        <div className="w-full h-full">
          <div className="w-full h-full rounded-lg bg-white shadow-lg dark:bg-neutral-800">
            <div className="g-0 lg:flex  lg:flex-wrap w-full h-full">
                ...
                <div className="md:mx-6 md:p-12 flex-1">
                  ...
                  <div className="text-center">
                    ...
                    <h4 className="mb-12 mt-1 pb-1 text-white text-xl font-semibold">
                      We are The{" "}
                      <span className="text-logo-color font-bold">RQ</span> Team
                    </h4>
                  </div>
