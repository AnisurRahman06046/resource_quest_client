...
function Banner() {
  return (
    ...
    <section className="bg-center pt-5 bg-no-repeat bg-cover bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg')] bg-gray-700 bg-blend-multiply">
    <div className="lg:px-4  lg:mx-auto max-w-screen-xl text-center py-24 lg:py-56">
  ...
  "The best way to predict your future is to create it."
    <span className="block text-sm text-gray-500 mt-1">— Abraham Lincoln</span>
  </p>
</div>
